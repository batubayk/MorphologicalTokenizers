...
if __name__ == "__main__":
    ...
    hun_tokenizer = HungarianMorphologicalTokenizer(pos_tagger_model_path="../data/hu_news/data/szeged.model")
    #hun_tokenizer.train(file="../data/hu_news/data/test.tsv", vocab_size=5000)
    #hun_tokenizer.save("hun_morph_50k.pickle")
