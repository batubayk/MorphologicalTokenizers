...
class TurkishRootMorphologicalTokenizer:
                        ...
                        for analysis in disambiguated_word_analysis:
                            ...
                            for morpheme_data_piece in morphemes_data:
                                ...
                                if ":" in morpheme_data_piece:
                                    if idx == 0:
                                        root = morpheme_data_piece.split(":")[0]
                                        sent_tokens.append(root)
                                    else:
                                        morphemes += morpheme_data_piece.split(":")[0]
                                    idx += 1

                            if morphemes != "":
                                sent_tokens.append('#' + morphemes)
            ...
            for analysis in disambiguated_word_analysis:
                ...
                for morpheme_data_piece in morphemes_data:
                    ...
                    if ":" in morpheme_data_piece:
                        if idx == 0:
                            root = morpheme_data_piece.split(":")[0]
                            encoded_ids.append(self.vocab(root))
                        else:
                            morphemes += morpheme_data_piece.split(":")[0]
                        idx += 1

                if morphemes != "":
                    encoded_ids.append(self.vocab('#' + morphemes))
