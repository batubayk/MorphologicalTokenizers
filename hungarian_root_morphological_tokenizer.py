                ...
                if line_count >= begin and line_count < end:
                    ...
                    for sent in nltk.sent_tokenize(line):
                        ...
                        for token_pos in self.pos_tagger.tag_sentence(sent.split()):
                            ...
                            idx = 0
                            if disambiguated_morpheme_data is None or token_pos[2] == '[Punct]':
                                ...
                                for morpheme in morphemes:
                                    ...
                                    if morpheme != '' and idx == 0:
                                        ...
                                        morphemes_combined += morpheme
                                    else:
                                        pass
                                        # print(morpheme)

                                    idx += 1
                                if morphemes_combined != "":
                                    sent_tokens.append("#" + morphemes_combined)
            ...
            for token_pos in self.pos_tagger.tag_sentence(sent.split()):
                ...
                if disambiguated_morpheme_data is None or token_pos[2] == '[Punct]':
                    ...
                    for morpheme in morphemes:
                        ...
                        elif morpheme != '' and idx > 0: # combine morphemes
                            morphemes_combined+=morpheme
                        else:
                            #print(morpheme)
                            pass
                        ...
                        idx += 1
                    if morphemes_combined!="":
                        encoded_ids.append(self.vocab("#" + morphemes_combined))
